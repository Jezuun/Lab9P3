 ...
 * @version 2016.02.29
 * 
 * 36. Do you only need to edit the CommandWords class?
 * Yes, only the CommandWords class needs editing.
 * Why is this significant?
 * It centralizes command management.
 * 
...
public class Game 
{
    ...
    /**
     * "look" command: prints the current room description again.
     */
    private void look() {
        System.out.println(currentRoom.getLongDescription());
    }
